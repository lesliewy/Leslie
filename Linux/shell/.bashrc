...
set -o vi
alias cds='cd /home/leslie/Shortcut'
...
export PATH=/sbin/:/home/leslie/Shortcut:$JAVA_HOME/bin:$MAVEN_HOME/bin:/opt/bc3/bin/:$ANT_HOME/bin:$ANDROID_SDK_HOME/tools:$ANDROID_SDK_HOME/platform-tools:$NUTCH_HOME/runtime/local/bin:$HBASE_HOME/bin:$HOME/Android/bin:$GROOVY_HOME/bin:$RUBY_HOME/bin:$NODE_HOME/bin:$PATH

# export DISPLAY=localhost:1.0

export R_HOME=/usr/lib/R

# rjava 中会使用 java.library.path.  这里设置的LD_LIBRARY_PATH在jvm启动时会读取, 追加到 java.library.path后面.  
# 也可以在 jvm的启动参数中设置.
export LD_LIBRARY_PATH=/usr/lib/R/site-library/rJava/jri/:/usr/local/lib/
